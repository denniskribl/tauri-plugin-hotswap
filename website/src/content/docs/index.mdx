...
template: splash
hero:
  tagline: Open-source OTA updates for Tauri v2. Push frontend fixes to your users in minutes — no app store, no rebuild.
  actions:
    - text: Get Started
      link: /tauri-plugin-hotswap/readme/
      icon: right-arrow
      variant: primary
    - text: GitHub
...
<Steps>
1. **Configure** the plugin in your Tauri app → [Configuration](/tauri-plugin-hotswap/configuration/)
2. **Set up** your update endpoint → [Server Contract](/tauri-plugin-hotswap/server-contract/)
3. **Build & sign** your first bundle → [Creating Bundles](/tauri-plugin-hotswap/creating-bundles/)
4. **Wire** the frontend API → [API Reference](/tauri-plugin-hotswap/api-reference/)
</Steps>
